				...
				<div class="col-12 col-lg-8">
                    <div class="single-blog-content mb-50">
                            <div id="dnn_ContentPane">
                                <div class="DnnModule DnnModule-DNN_HTML DnnModule-10952">
                                    <a name="10952"></a>
                                    <h4 class="header-title m-t-0">
                                        <span id="dnn_ctr10952_TITLE1_titleLabel" class="m_title">Đào tạo</span>
                                    </h4>
                                    <div id="dnn_ctr10952_ContentPane">
                                        <!-- Start_Module_10952 -->
                                        <div id="dnn_ctr10952_ModuleContent">
                                            <div id="dnn_ctr10952_HtmlModule_lblContent" class="Normal">
                                                - 
                                                <a tabindex="0" href="http://hus.vnu.edu.vn/tai-lieu-bieu-mau/quy-dinh-quy-che/dao-tao/dai-hoc.html">Đại học</a>
                                                <br />
                                                - 
                                                <a href="http://hus.vnu.edu.vn/tai-lieu-bieu-mau/quy-dinh-quy-che/dao-tao/sau-dai-hoc.html">Sau đại học</a>
                                            </div>
                                        </div>
                                        <!-- End_Module_10952 -->
                                    </div>
...
=======
                                                            <a href="#3112" class="submenu spn">
                                                                <span class="ink animate-ink " style="height: 359px; width: 359px;top: -158.5px;left: 143.344px;"></span> Nhận diện thương hiệu
                                                                <span class="submenu-indicator " >+</span>
                                                            </a>
                                                            <div class="content d-none">
                                                                <ul class="submenu" style="display: block;" id="3112">
>>>>>>> eab4e6f6b1ff04b8d87783a06866345b6540c41a
                                                                    <li class="active li-me">
