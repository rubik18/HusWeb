			...
			<div class="row">
				<div class="col-12">
					<ol class="breadcrumb">
                        ...
                        <img src="http://hus.vnu.edu.vn/images/breadcrumb.gif">&nbsp;
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="#" class="item ">Quy định</a></li>
					</ol>
				</div>
			</div>
		</div>
                        ...
                        <div id="dnn_ContentPane">
                            <div class="DnnModule DnnModule-DNN_HTML DnnModule-12923">
                                    ...
                                    <h4 class="header-title m-t-0">
                                        <span id="dnn_ctr12923_TITLE1_titleLabel" class="m_title">Quy định</span></h4>
                                                                ...
                                                                <ul class="submenu" style="display: block;" id="32">
                                                                    ...
                                                                    <li class="active li-me">
                                                                        <a href="" style="color: #017dc5;
                                                                            ...
                                                                            font-weight: 600;
                                                                            padding-left: 27px;">Quy định</a></li>
                                                                    <li class="li-me">
                                                                        <a href="tepvaha.php">Tệp và hình ảnh</a></li>
                                                                </ul>
                                                            </div>
                                                        </li>
