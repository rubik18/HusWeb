            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="../thuonghieu.php" class="item ">Nhận diện thương hiệu</a></li>&nbsp;
                        <img src="http://hus.vnu.edu.vn/images/breadcrumb.gif">&nbsp;
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="#" class="item ">Tệp và hình ảnh</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="single-blog-content mb-50">
                        <div id="dnn_ContentPane">
                            <div class="DnnModule DnnModule-DNN_HTML DnnModule-12923">
                                    <a name="12923"></a>
                                    <h4 class="header-title m-t-0">
                                        <span id="dnn_ctr12923_TITLE1_titleLabel" class="m_title">Tệp và hình ảnh</span>
                                    </h4>
                                    <div id="dnn_ctr12923_ContentPane">
                                        <!-- Start_Module_12923 -->
