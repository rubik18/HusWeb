			...
			<div class="row">
				<div class="col-12">
					<ol class="breadcrumb">
                        ...
                        <img src="http://hus.vnu.edu.vn/images/breadcrumb.gif">&nbsp;
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="#" class="item ">Đào tạo</a></li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-12 col-lg-8">
                    <div class="single-blog-content mb-50">
                        <div id="dnn_ContentPane"><div class="DnnModule DnnModule-DNN_HTML DnnModule-12894"><a name="12894"></a>
                                <div class="post-container">
                                    <h1 class="post-title">
                                        <span id="dnn_ctr12894_TITLE1_titleLabel" class="Head">Đào tạo</span></h1>
                                    <div class="post-content">
                                        <div id="dnn_ctr12894_ContentPane">
                                            <!-- Start_Module_12894 -->
                                            <div id="dnn_ctr12894_ModuleContent">
                                                <div id="dnn_ctr12894_HtmlModule_lblContent" class="Normal">
                                                    <p style="text-align: justify;">
                                                        <span style="font-family: Tahoma; font-size: 13px;"><a href="http://hus.vnu.edu.vn/tai-lieu-bieu-mau/bieu-mau/dao-tao/dai-hoc.html" tabindex="0">
                                                        - Đại học</a></span></p>
                                                    <a href="http://hus.vnu.edu.vn/tai-lieu-bieu-mau/bieu-mau/dao-tao/sau-dai-hoc.html" tabindex="0">
                                                        <p>
                                                            <span style="font-family: Tahoma; font-size: 13px;">- Sau&nbsp;Đại học</span></p>
                                                    </a>
                                                </div>
                                            </div><!-- End_Module_12894 -->
                                        </div>
                                    </div>
                                </div>
                        </div></div>
                                                                ...
                                                                <ul class="submenu" style="display: block;" id="4101">
                                                                    ...
                                                                    <li class="li-me">
                                                                        <a href=""style="color: #017dc5;
                                                                            ...
                                                                            font-weight: 600;
                                                                            padding-left: 27px;">Đào tạo</a></li>
                                                                    <li class="li-me">
