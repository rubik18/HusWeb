            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        &nbsp;
                        <img alt="*" src="\php-intership-team\img\img-nhung/breadcrumb.gif">
                        <a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/trung-tam-nghien-cuu/trung-tam-nghien-cuu-PT-va-UDKHPT.php" class="item">Trung tâm Nghiên cứu phát triển và Ứng dụng khoa học phân tích </a>
                    </ol>
                </div>
            </div>
        </div>
                                                    ...
                                                    <li class="trum">
                                                        ...
                                                        <div class="content">
                                                            <ul class="submenu" style="display: block;">
                                                                ...
                                                                <li class="active li-me"><a style="color: #017dc5;background: #f6f7f9; border-left: solid 3px #017dc5;font-weight: 600; padding-left: 27px;" href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/trung-tam-nghien-cuu/trung-tam-nghien-cuu-PT-va-UDKHPT.php">Trung tâm Nghiên cứu phát triển và Ứng dụng khoa học phân tích</a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="trum">
