					            ...
					            <div id="dnn_ctr15977_ContentPane"><!-- Start_Module_15977 --><div id="dnn_ctr15977_ModuleContent">
								    ...
								    <tbody>
								        ...
								        <tr>
								            ...
								            <td colspan="2" style="padding: 0px; margin: 0px; width: 548px; height: 15px;"><span style="text-decoration-style: initial; text-decoration-color: initial; color: #336699;">Đảng - Đoàn thể</span></td>
								        </tr>
								        <tr>
								            ...
								            <td style="padding: 0px; margin: 0px; width: 528px; height: 15px;"><a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/dang-doan-the/dang-uy.php"><span style="color: #336699;">Đáng ủy</span></a></td>
								        </tr>
								        <tr>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;">&nbsp;</td>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;" valign="top">|_</td>
								            <td style="padding: 0px; margin: 0px; width: 528px; height: 15px;"><a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/dang-doan-the/doan-thanh-nien.php"><span style="color: #336699;">Đoàn Thanh niên</span></a></td>
								        </tr>
								        <tr>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;">&nbsp;</td>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;" valign="top">|_</td>
								            <td style="padding: 0px; margin: 0px; width: 528px; height: 15px;"><a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/dang-doan-the/hoi-sinh-vien.php"><span style="color: #336699;">Hội sinh viên</span></a></td>
								        </tr>
								        <tr>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;">&nbsp;</td>
								            <td style="padding: 0px; margin: 0px; width: 20px; height: 15px;" valign="top">|_</td>
								            <td style="padding: 0px; margin: 0px; width: 528px; height: 15px;"><a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/dang-doan-the/cong-doan.php"><span style="color: #336699;">Công đoàn</span></a></td>
								        </tr>
								    </tbody>
								</table>
								</div>
