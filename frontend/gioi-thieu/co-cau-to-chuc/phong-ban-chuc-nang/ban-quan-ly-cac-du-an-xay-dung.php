<title>Ban quản lý các dự án xây dựng</title>
<!-- start header -->
...
<div class="main-content-wrapper">
    <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        &nbsp;
                        <img alt="*" src="\php-intership-team\img\img-nhung/breadcrumb.gif">
                        <a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/ban-quan-ly-cac-du-an-xay-dung.php" class="item">Ban quản lý các dự án xây dựng</a>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="world-latest-articles">
            <div class="row">
                <!-- start nội dung-cơ cấu tổ chức -Phòng ban chức năng- Ban quản lý các dự án xây dựng-->
                        ...
                        <div >
                            <div class="DnnModule ">
                                ...
                                <div >
                                    ...
                                    <div>
                                        <div class="post-meta">
                                            <h1>Ban quản lý các dự án xây dựng</h1>
                                        </div>
                                        <div class="post-content">
                                            <div>
                                            	<div>
                                            		<div class="Normal">
														<p><span><strong>1. Chức năng</strong></span></p>
														<p><span>Tham mưu, tư vấn cho Hiệu trưởng trong công tác quản lý và triển khai thực hiện các Dự án xây dựng do Trường ĐHKHTN quản lý hoặc được giao phối hợp thực hiện.</span></p>
														<p><span><strong>2. Nhiệm vụ</strong></span></p>
														<p><span><strong>2.1. Công tác quản lý và triển khai thực hiện các dự án xây dựng</strong></span></p>
														<p><span>- Xây dựng và hướng dẫn tổ chức, kiểm tra, giám sát triển khai quy hoạch về đầu tư xây dựng của Trường ĐHKHTN.</span></p>
														<p><span>- Thẩm định về chuyên môn, đề xuất dự toán kinh phí và trình Hiệu trưởng phê duyệt hồ sơ đầu tư xây dựng theo quy định.</span></p>
														<p><span>- Đầu mối giải quyết các vấn đề về thủ tục đầu tư xây dựng và thực hiện các thủ tục tài chính liên quan tới việc thực hiện và nghiệm thu các đầu việc của dự án theo quy định.</span></p>
														<p><span>- Đầu mối giải quyết các vấn đề về xây dựng Trường ĐHKHTN tại Hòa Lạc.</span></p>
														<p><span>- Thực hiện công tác quy hoạch, xây mới, cải tạo cơ sở hạ tầng và hệ thống nhà xưởng, phòng làm việc, phòng học trong các khuôn viên Trường được thực hiện theo dự án. Tổ chức nghiệm thu và quản lý các công việc trên theo quy định.</span></p>
														<p><span>- Đề xuất, kiến nghị với Hiệu trưởng về các vấn đề liên quan tới các dự án xây dựng của Trường.</span></p>
														<p><span><strong>2.2. Nhiệm vụ phối hợp với các đơn vị khác</strong></span></p>
														<p><span><strong>-&nbsp;</strong>Phối hợp với các phòng, ban chức năng và các đơn vị trong việc triển khai thực hiện các nhiệm vụ do Hiệu trưởng phân công phụ trách.</span></p>
														<p><span><strong>-</strong>&nbsp;Phối hợp với các đơn vị thực hiện các nhiệm vụ khác do Hiệu trưởng giao.</span></p>
													</div>
                                            	</div>
                                            </div>
                                        </div>
                ...
                <!-- end nội dung - cơ cấu tổ chức-Phòng ban chức năng -Ban quản lý các dự án xây dựng-->
                                                    ...
                                                    <li class="trum">
                                                        ...
                                                        <div class="content">
                                                            <ul class="submenu" style="display: block;">
                                                                ...
                                                                <li class="active li-me"><a style="color: #017dc5;background: #f6f7f9; border-left: solid 3px #017dc5;font-weight: 600; padding-left: 27px;" href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/ban-quan-ly-cac-du-an-xay-dung.php">Ban quản lý các dự án xây dựng</a></li>
