            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        &nbsp;
                        <img alt="*" src="\php-intership-team\img\img-nhung/breadcrumb.gif">
                        <a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/trung-tam-cong-nghe-thong-tin-va-truyen-thong.php" class="item">Trung tâm Công nghệ thông tin và Truyền thông</a>
                    </ol>
                </div>
            </div>
        </div>
