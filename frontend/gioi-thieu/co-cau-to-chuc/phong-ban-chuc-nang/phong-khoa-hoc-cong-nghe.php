            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        &nbsp;
                        <img alt="*" src="\php-intership-team\img\img-nhung/breadcrumb.gif">
                        <a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/phong-khoa-hoc-cong-nghe.php" class="item">Phòng Khoa học-Công nghệ</a>
                    </ol>
                </div>
            </div>
        </div>
                                                    ...
                                                    <li class="trum">
                                                        ...
                                                        <div class="content">
                                                            <ul class="submenu" style="display: block;">
                                                                ...
                                                                <li class="active li-me"><a style="color: #017dc5;background: #f6f7f9; border-left: solid 3px #017dc5;font-weight: 600; padding-left: 27px;" href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/phong-khoa-hoc-cong-nghe.php">Phòng Khoa học - Công nghệ</a></li>
                                                                ...
                                                                <li class="active li-me"><a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/phong-ban-chuc-nang/phong-ke-hoach-tai-chinh.php">Phòng kế hoạch - Tài chính</a></li>
