<title>Khoa Toán - Cơ - Tin học</title>
<!-- start header -->
    ...
    <div class="container">
        ...
        <div class="world-latest-articles">
            <div class="row">
                ...
                <!-- end nội dung - cơ cấu tổ chức-Khoa Trực thuộc- Khoa Toán-Cơ-Tin học-->
                                            ...
                                            <div class="jquery-accordion-menu">
                                                ...
                                                <ul class="right-me">
                                                    ...
                                                    <li class="trum">
                                                        ...
                                                        <div class="content ">
                                                            <ul class="submenu" style="display: block;">
                                                                <li class="active li-me"><a style="color: #017dc5;background: #f6f7f9; border-left: solid 3px #017dc5;font-weight: 600; padding-left: 27px;" href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/khoa-truc-thuoc/khoa-toan-co-tin-hoc.php">Khoa Toán - Cơ - Tin học</a></li>
