            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        &nbsp;
                        <img alt="*" src="\php-intership-team\img/img-nhung/breadcrumb.gif">
                        <a href="/php-intership-team/frontend/gioi-thieu/co-cau-to-chuc/so-do-to-chuc.php" class="item">Sơ đồ tổ chức</a>
                    </ol>
                </div>
            </div>
        </div>
                                            	...
                                            	<tbody>
                                            		<tr>
                                            			<td class="pic" style="text-align: left;">
                                            				<img alt="" src="\php-intership-team\img\img-nhung/so-do-phong-ban-hus.jpg" usemap="#rade_img_map_1563204484810" style="border-width: 0px; border-style: solid;">
                                            			</td>
                                            		</tr>
                                            		<tr>
