                    ...
                    <div class="col-12 col-lg-12">
                        <div class="single-blog-content mb-50">
                            <div id="dnn_ContentPane">
                                                        ...
                                                        <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                                                            <div class="jquery-accordion-menu-header">Sau đại học </div>
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="\php-intership-team\frontend\dao-tao\sau-dai-hoc\sinh-hoc.php">Sinh học &amp; Công nghệ</a></li>
                                ...
                                <div class="DnnModule DnnModule-Tintc-HUSDaotao DnnModule-12661"><a name="12661"></a>
                                    <div id="dnn_ctr12661_ContentPane"><!-- Start_Module_12661 -->
                                        <div id="dnn_ctr12661_ModuleContent">
                                            ...
                                            <link rel="stylesheet" href="/php-intership-team/css/chen-slide.css">
                                                ...
                                                <div id="verticalTab" class="resp-vtabs" style="display: block; width: 100%; margin: 0px;">
                                                    <ul class="resp-tabs-list">
                                                        ...
                                                        <li class="resp-tab-item resp-tab-active" aria-controls="tab_item-0" role="tab">Động vật học</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-1" role="tab">Di truyền học</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-2" role="tab">Sinh thái học</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-3" role="tab">Sinh học thực nghiệm</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-4" role="tab">Thực vật học</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-5" role="tab">Thủy sinh vật học</li>
                                                    
                                                        <li class="resp-tab-item" aria-controls="tab_item-6" role="tab">Vi sinh vật học</li>
