                    ...
                    <div class="col-12 col-lg-12">
                        <div class="single-blog-content mb-50">
                            <div id="dnn_ContentPane">
                                                    ...
                                                    <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                                                        <div class="jquery-accordion-menu-header">Bậc Đại học </div>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="active"><a href="\php-intership-team\frontend\dao-tao\bac-dai-hoc\khi-tuong.php">Khí tượng, Khoa học và Công nghệ biển, Tài nguyên và Môi trường nước</a></li>
                                ...
                                <div class="DnnModule DnnModule-Tintc-HUSDaotao DnnModule-12650"><a name="12650"></a>
                                    <div id="dnn_ctr12650_ContentPane"><!-- Start_Module_12650 -->
                                        <div id="dnn_ctr12650_ModuleContent">
                                        ...
                                        <div id="verticalTab" class="resp-vtabs" style="display: block; width: 100%; margin: 0px;">
                                            ...
                                            <ul class="resp-tabs-list">
                                                ...
                                                <li class="resp-tab-item resp-tab-active" aria-controls="tab_item-0" role="tab">Khí tượng học</li>
                                            
                                                <li class="resp-tab-item" aria-controls="tab_item-1" role="tab">Khí tượng học chất lượng cao</li>
                                            
                                                <li class="resp-tab-item" aria-controls="tab_item-2" role="tab">Thủy văn học</li>
                                            
                                                <li class="resp-tab-item" aria-controls="tab_item-3" role="tab">Thủy văn chất lượng cao</li>
                                            
                                                <li class="resp-tab-item" aria-controls="tab_item-4" role="tab">Hải dương học</li>
                                            
                                                <li class="resp-tab-item" aria-controls="tab_item-5" role="tab">Hải dương học chất lượng cao</li>
                                            ...
                                            <div class="resp-tabs-container">
                                                ...
                                                <h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span>Thủy văn học</h2>
                                                ...
                                                <h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span>Thủy văn chất lượng cao</h2>
                                                ...
                                                <h2 class="resp-accordion" role="tab" aria-controls="tab_item-4"><span class="resp-arrow"></span>Hải dương học</h2>
                                                ...
                                                <h2 class="resp-accordion" role="tab" aria-controls="tab_item-5"><span class="resp-arrow"></span>Hải dương học chất lượng cao</h2>
