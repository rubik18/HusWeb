                                    ...
                                    <div id="dnn_ctr10557_ModuleContent">
                                        <div id="dnn_ctr10557_Main_ctl00_up">
                                            ...
                                            <div class="news-details">
                                                <!-- Post Meta -->
                                                <div class="title">
                                                    <h1>CEFD - một trong những nhân tố quan trọng góp phần tạo nên thành công của gói thầu </h1>
                                                </div>
                                                <div class="post-meta">
                                                    <div>
                                                ...
                                                <div class="post-content">
                                                    <p>
                                                        <strong>Sáng ngày 24/7/2020, tại Trung tâm Hội nghị Quốc tế, 11 Lê Hồng Phong, Ba Đình, Hà Nội, Tổng cục Phòng, chống thiên tai - Ban Quản lý dự án Vận hành hồ chứa trong tình huống khẩn cấp và quản lý lũ hiệu quả bằng hệ thống t </strong>
                                                    </p>
                                                    <p style="text-align: justify;">Trung tâm Động lực học Thủy khí Môi trường (CEFD), Trường Đại học Khoa học Tự nhiên đã tham dự Hội thảo Tổng kết gói thầu “Xây dựng k.</p>

                                                    <div style="text-align:center">
                                                        <figure class="image" style="display:inline-block"><a class="newsslidephoto" href="" rel="newsdetailslidephoto" title="CEFD - một trong những nhân tố quan trọng góp phần tạo nên thành công của gói thầu “Xây dựng kế hoạch phòng chống thiên tai cấp tỉnh gắn với quản lý lũ tổng hợp một số lưu vực sông khu vực Nam Trung Bộ và Tây Nguyên”"><img alt="" width="500" /></a>
                                                        </figure>
                                                    </div>
