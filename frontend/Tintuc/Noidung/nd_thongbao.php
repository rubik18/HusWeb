...
<div class="row" style="padding: 0px; margin: 0px;">
    <div class="col-12 col-lg-3">
        <div class="titlethongbao" style="height: 29px; line-height: 29px; background: url(http://hus.vnu.edu.vn/hus/img/blog-img/homethongbao.png) no-repeat left bottom #017dc5;margin-bottom: 10px;border-radius: 5px 5px 0px 0px;">
    ...
    <div class="col-12 col-lg-6  pdr-0  pdl-0">
        <div class="news-details">
            <div id="dnn_ctr10933_newsviewer_ctl00_up">
                    ...
                    <div class="title">
                        <h1>
                            Kết quả xét công nhận đạt tiêu chuẩn chức danh Giáo sư, Phó Giáo sư năm 2020</h1>
                    </div>
                    <div class="post-meta">
                        <div>
                            <a href="#" class="post-date">
                                <i class="fa fa-clock-o"></i> 10:43 03/08/2020</a>
                        </div>
                        <div class='social'>
