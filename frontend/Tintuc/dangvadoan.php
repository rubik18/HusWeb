                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                            ...
                            <div>
                                ...
                                if($page >= 4&& $page <=7){ ?>
                                    <li>
                                    <a id="dnn_ctr10929_newsviewer_ctl00_vbPaging_btnNext" class="inactive" href="dangvadoan.php?page=1" style="padding-top: 10px"><i class="fa fa-angle-double-left"></i></a></li>
                                    <?php for ($x = 4; $x < 7; $x++) {
