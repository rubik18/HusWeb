...
// Chuỗi kết nối
  $sql = "SELECT `new`.*,`category`.`name` FROM `new`, `category` WHERE new.id_category = category.id AND category.`name`='Tin tức chung' AND new.deleted_at is NULL ORDER BY new.created_at DESC LIMIT $ipage,4 ";
