...
<div class="col-12 col-lg-9 pdr-0">
                            ...
                            <div class="item-image">
                                <a href="" class="content">
                                    <span itemprop="image" itemscope="" itemtype="">
                                        <img src="http://hus.vnu.edu.vn/DATA//IMAGES/2020/07/dsc08732-1.jpg?width=260&height=170&mode=crop&anchor=topcenter" itemprop="url">
                                    </span>
                                </a>
                            </div>
            </div>
            <div class="magazine-item-main">
			     <p style="padding: 7px 0px;margin: 0px;color: #8d8d8d!important;"><a href="#" class="item ">Tin tức chung</a></p>
                <div class="article-title">
                    <h3 itemprop="name">
                        <a href=""class="content">Trường Đại học Khoa học Tự nhiên tổ chức tập huấn công tác coi thi kỳ thi tốt nghiệp THPT năm 2020</a>
                    </h3>
                </div>	
                <aside class="article-aside clearfix">
                    <dl class="article-info muted">
                        <dd class="published hasTooltip" title="Được đăng: ">
                            ...
                            <time datetime="17:06 30/07/2020">17:06 30/07/2020</time>
                        </dd>
                    </dl>
                </aside>
                <div class="magazine-item-ct">
                    <p style="text-align: justify;">Ngày 30/7/2020, tại Hội trường tầng 7 nhà T5, Trường Đại học Khoa học Tự nhiên tổ chức tập huấn cho các cán bộ, giảng viên tham gia kiểm tra, giám sát kỳ thi tốt nghiệp THPT năm 2020.
                    </p>
                </div>
            </div>
    </div><!--end box-1 --------------->
    ...
    <div class="col-12 col-lg-3" >
       <div class="bordershadown borderorange mb-15 pd-10" style="float: left">
            <!-- <link href="./Tin tức_files/Khoastyle.css" rel="stylesheet"> -->
            <div class="content">
