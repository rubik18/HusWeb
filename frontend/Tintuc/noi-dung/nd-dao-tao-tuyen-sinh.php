 ...
 ?>
  ...
  <title>
    ...
    ?>
        ...
        <link rel="stylesheet" type="text/css" href="/php-intership-team/css/tictuc_tham.css">
        <link rel="stylesheet" type="text/css" href="/php-intership-team/css/canbo_tham.css">
        <div class="main-content-wrapper" id="In4" >
            <div class="container" >
                 <!--------start thanh muc luc------------------->
                    ...
                    <div class="row" >
                        <div class="col-12">
                              <nav><ol class="breadcrumb" style="padding-top: 0 !important">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="/php-intership-team/frontend/Tintuc/daotaots.php" class="item ">Đào tạo Tuyển sinh</a></li>
                              </ol></nav>
                            </div></div>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="single-blog-content mb-50">
                            ...
                            <div class="at-share-btn-elements">
                                <a href="javascript:void(0)" onclick="Share_Content('http://www.facebook.com/sharer.php?u=nd-dao-tao-tuyen-sinh.php?id=<?php echo $id ?>')" role="button" tabindex="0" class="hvr-float transition" class="at-icon-wrapper at-share-btn at-svc-facebook"  style="background-color: rgb(59, 89, 152); border-radius: 6px;padding: 5px;margin-bottom: 5px;">
                                ...
                                <a href="javascript:void(0)" onclick="Share_Content('https://twitter.com/intent/tweet?text=<?php echo $row['title'] ?>&url=nd-dao-tao-tuyen-sinh.php?id=<?php echo $id ?>&via=TWITTER-HANDLER')" role="button" tabindex="0" class="hvr-float transition" class="at-icon-wrapper at-share-btn at-svc-twitter" style="background-color: rgb(29, 161, 242); border-radius: 6px;padding: 5px;margin-bottom: 5px; ">
                                    <span class="at4-visually-hidden"></span>
                                    <span class="at-icon-wrapper" style="line-height: 20px; height: 20px; width: 20px;">
                                ...
                                <a href="javascript:void(0)" onclick="Share_Content('http://pinterest.com/pin/create/button/?url=nd-dao-tao-tuyen-sinh.php?id=<?php echo $id ?>&description=<?php echo $row['title'] ?>&media=<?php echo $row['avatar'] ?>')" role="button" tabindex="0" class="hvr-float transition" class="at-icon-wrapper at-share-btn at-svc-email" style="background-color: rgb(132, 132, 132); border-radius: 6px;padding: 5px;margin-bottom: 5px; ">
                                    <!-- <span class="at4-visually-hidden"></span>
                                    <span class="at-icon-wrapper" style="line-height: 20px; height: 20px; width: 20px;">
                                ...
                                <a href="javascript:void(0)" onclick="Share_Content('http://www.linkedin.com/shareArticle?mini=true&url=nd-dao-tao-tuyen-sinh.php?id=<?php echo $id ?>&title=<?php echo $row['title'] ?>&source=nd-dao-tao-tuyen-sinh.php?id=<?php echo $id ?>')" role="button" tabindex="0" class="hvr-float transition" class="at-icon-wrapper at-share-btn at-svc-linkedin" style="background-color: rgb(0, 119, 181); border-radius: 6px;padding: 5px;margin-bottom: 5px; ">
                                    <span class="at4-visually-hidden"></span>
                                    <span class="at-icon-wrapper" style="line-height: 20px; height: 20px; width: 20px;">
                                ...
                                <a href="javascript:void(0)" onclick="In_Content('In4')" role="button" tabindex="0" class="hvr-float transition" class="at-icon-wrapper at-share-btn at-svc-print" style="background-color: rgb(115, 138, 141); border-radius: 6px;padding: 5px;margin-bottom: 5px; ">
                                    <span class="at4-visually-hidden "></span>
                                    ...
                                    <span class="at-label" style="font-size: 10.5px; line-height: 20px; height: 20px; color: rgb(255, 255, 255);">In&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                ...
                                                <div class="post-content">
                                                    <p>
                                                        <strong><?php echo  $row['description'] . "<br>";?></strong>
                                                    </p>
                            ...
                            <div class="content">
                                <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="/php-intership-team/frontend/Tintuc/daotaots.php">Đào tạo - Tuyển sinh</a></li>
